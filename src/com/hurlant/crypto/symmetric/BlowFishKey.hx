...
class BlowFishKey implements ISymmetricKey
{
    ...
    private static var KP : Array<Dynamic> = [0x243F6A88, 0x85A308D3, 0x13198A2E, 0x03707344, 0xA4093822, 0x299F31D0, 
        0x082EFA98, 0xEC4E6C89, 0x452821E6, 0x38D01377, 0xBE5466CF, 0x34E90C6C, 0xC0AC29B7, 0xC97C50DD, 0x3F84D5B5, 
        0xB5470917, 0x9216D5D9, 0x8979FB1B];
    
    private static var KS0 : Array<Dynamic> = [0xD1310BA6, 0x98DFB5AC, 0x2FFD72DB, 0xD01ADFB7, 0xB8E1AFED, 0x6A267E96, 0xBA7C9045, 0xF12C7F99, 0x24A19947, 
    ...
    private static var KS1 : Array<Dynamic> = [0x4B7A70E9, 0xB5B32944, 0xDB75092E, 0xC4192623, 0xAD6EA6B0, 0x49A7DF7D, 0x9CEE60B8, 0x8FEDB266, 0xECAA8C71, 
    ...
    private static var KS2 : Array<Dynamic> = [0xE93D5A68, 0x948140F7, 0xF64C261C, 0x94692934, 0x411520F7, 0x7602D4F7, 0xBCF46B2E, 0xD4A20068, 0xD4082471, 
    ...
    private static var KS3 : Array<Dynamic> = [0x3A39CE37, 0xD3FAF5CF, 0xABC27737, 0x5AC52D1B, 0x5CB0679E, 0x4FA33742, 0xD3822740, 0x99BC9BBE, 0xD5118E9D, 
    ...
    private var S0 : Array<Dynamic>;
    private var S1 : Array<Dynamic>;
    private var S2 : Array<Dynamic>;
    private var S3 : Array<Dynamic>;  // the s-boxes  
    private var P : Array<Dynamic>;  // the p-array  
    ...
    {
        var i : Int = 0;
        for (i in 0...S0.length){S0[i] = 0;
        }
        for (i in 0...S1.length){S1[i] = 0;
        }
        for (i in 0...S2.length){S2[i] = 0;
        }
        for (i in 0...S3.length){S3[i] = 0;
        }
        for (i in 0...P.length){P[i] = 0;
        }
        S0 = null;
        S1 = null;
        S2 = null;
    ...
    {
        var xl : Int = BytesTo32bits(src, srcIndex);
        var xr : Int = BytesTo32bits(src, srcIndex + 4);
