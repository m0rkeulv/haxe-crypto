...
class AESKey implements ISymmetricKey {
    ...
    private static var _Sbox = [ // forward s-box
    ...
    private static var _InvSbox = [ // inverse s-box
    ...
    private static var _Xtime2Sbox = [ // combined Xtimes2[Sbox[]]
    ...
    private static var _Xtime3Sbox = [ // combined Xtimes3[Sbox[]]
    ...
    private static var _Rcon = [0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36];
