...
class AESKey implements ISymmetricKey {
    ...
    static private function initOnce() {
        ...
        for (i in 0...256) Sbox[i] = Tables._Sbox[i];
        for (i in 0...256) InvSbox[i] = Tables._InvSbox[i];
        for (i in 0...256) Xtime2Sbox[i] = Tables._Xtime2Sbox[i];
        for (i in 0...256) Xtime3Sbox[i] = Tables._Xtime3Sbox[i];
        for (i in 0...256) Xtime2[i] = Tables._Xtime2[i];
        for (i in 0...256) Xtime9[i] = Tables._Xtime9[i];
        for (i in 0...256) XtimeB[i] = Tables._XtimeB[i];
        for (i in 0...256) XtimeD[i] = Tables._XtimeD[i];
        for (i in 0...256) XtimeE[i] = Tables._XtimeE[i];
        Rcon = new ByteArray();
        for (i in 0...Tables._Rcon.length) Rcon[i] = Tables._Rcon[i];
    }
...
class Tables {
    ...
    public static var _Sbox = [ // forward s-box
    ...
    public static var _InvSbox = [ // inverse s-box
    ...
    public static var _Xtime2Sbox = [ // combined Xtimes2[Sbox[]]
    ...
    public static var _Xtime3Sbox = [ // combined Xtimes3[Sbox[]]
    ...
    public static var _Rcon = [0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36];
