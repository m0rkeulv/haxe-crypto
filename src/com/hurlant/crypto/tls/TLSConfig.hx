...
class TLSConfig
{
    public var entity : Int;  // SERVER | CLIENT  
    ...
    public function new(entity : Int, cipherSuites : Array<Dynamic> = null, compressions : Array<Dynamic> = null,
            certificate : ByteArray = null, privateKey : RSAKey = null, CAStore : X509CertificateCollection = null, ver : Int = 0x00)
    {
        this.entity = entity;
