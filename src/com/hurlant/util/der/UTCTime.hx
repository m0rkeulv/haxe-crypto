...
class UTCTime implements IAsn1Type
{
    ...
    public function setUTCTime(str : String) : Void{
        ...
        var year : Int = Std2.parseInt(str.substr(0, 2));
        if (year < 50) {
            year += 2000;
        }
        else {
        ...
        var month : Int = Std2.parseInt(str.substr(2, 2));
        var day : Int = Std2.parseInt(str.substr(4, 2));
        var hour : Int = Std2.parseInt(str.substr(6, 2));
        var minute : Int = Std2.parseInt(str.substr(8, 2));
